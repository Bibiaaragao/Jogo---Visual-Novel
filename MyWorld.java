...
public class MyWorld extends World
{
    ...
    public void terceiroCenario() {
        ...
        caixa1.setTexto("- Isso aí! Não foi tão difícil assim.                 (clique aqui para passar o diálogo)\nReparando bem, esse castelo parece ser enorme, não terá problema explorar um pouco, certo?");
    ...
    switch(texto) {
        case 0:
            caixa1.setTexto("- Na verdade, terá um problema, sim.                  (clique aqui para passar o diálogo) \nVocê precisa passar por alguns desafios... - diz a mesma voz misteriosa");
            break;
        case 1:
            caixa1.setTexto("- De novo? O que ganharei depois de tudo isso?        (clique aqui para passar o diálogo)");
            break;
        case 2:
            caixa1.setTexto("- Um tesouro.                                         (clique aqui para passar o diálogo)");
            break;
        case 3:
            caixa1.setTexto("- SÉRIO? Então me explique quais são esses desafios.   (clique aqui para passar o diálogo)");
            break;
        case 4:
            caixa1.setTexto("- Direi apenas o primeiro. Será um jogo da memória,    (clique aqui para passar o diálogo)\nmas cuidado, há um número fixo de tentativas.");
            break;
        case 5:
            caixa1.setTexto("- Um jogo da memória não pode ser tão difícil assim,   (clique aqui para passar o diálogo) \nmas o que acontecerá se eu errar mais que o limite?");
            break;
        case 6:
            caixa1.setTexto("- Um péssimo futuro estará a sua espera...             (clique aqui para passar o diálogo)");
            break;
        case 7:
            caixa1.setTexto("- Hummm... Creio que não será tão difícil.             (clique aqui para passar o diálogo)\nAceitarei sua proposta.");
            break;
        case 8:
            caixa1.setTexto("- Ok, saiba que não poderá desistir depois de começar.  (clique aqui para passar o diálogo)");
            break;
        case 9:
            caixa1.setTexto("- Entendido.");
            break;
        default:
            break;
    }
    ...
    public void quartoCenario(){
        ...
        caixa1 = new CaixaTexto1();
        addObject(caixa1, 300, 50);
        caixa1.setTexto("Aqui é um pouquinho assustador, não é?                  (clique aqui para passar o diálogo)\n Será que há fantasmas por aqui?");
